...
const translations = {
  ...
  "3 tools": "3 أدوات",
  "4 tools": "4 أدوات",
  "Social Media Analytics": "تحليل منصات التواصل",
  "Instagram Account Audit": "تدقيق حسابات إنستغرام",
  "A full audit of any Instagram account: what the audience engages with, genuine versus internal likes, and an expert review of how the content is made, delivered as a PDF report.": "تدقيق كامل لأي حساب على إنستغرام: ما يتفاعل معه الجمهور، والإعجابات الحقيقية مقابل إعجابات الدائرة الداخلية، ومراجعة خبير لطريقة صنع المحتوى، في تقرير PDF.",
  ...
  "Understands any Instagram reel or post from its link: local text recognition in Arabic and English, audio classification and Shazam, with Gemini called only when needed. Built to be the foundation for larger tools.": "تفهم أي ريل أو منشور على إنستغرام من رابطه: قراءة النص محلياً بالعربية والإنجليزية، وتصنيف الصوت وShazam، ولا تستدعي Gemini إلا عند الحاجة. مبنية لتكون أساساً تُبنى فوقه أدوات أكبر.",
  "OCR": "OCR",
